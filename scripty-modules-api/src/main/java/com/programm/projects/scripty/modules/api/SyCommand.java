...
public interface SyCommand {
     ...
     * @param commandName the name with which this command was called.
     ...
     */
    void run(SyContext ctx, SyIO io, String commandName, Args args) throws CommandExecutionException;
